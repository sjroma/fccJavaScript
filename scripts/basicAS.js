...
function dropdownChoice() {
  ...
  switch (script) {
    ...
    case "factorial":
      ...
      document.getElementById("descText").innerHTML = "Return the factorial of the provided integer. If the integer is represented with the letter n, a factorial is the product of all positive integers less than or equal to n. Factorials are often represented with the shorthand notation n!<br> For example: 5! = 1 * 2 * 3 * 4 * 5 = 120<br> Only integers greater than or equal to zero will be supplied to the function.";
    ...
    case "longest":
      ...
      document.getElementById("descTests").innerHTML = "<li>'The quick brown fox jumped over the lazy sleeping dog' should return 8</li>'May the force be with you' should return 5<li>'Google do a barrel roll' should return 6</li>'What is the average airspeed velocity of an unladen swallow' should return 8<li>'What if we try a super-long word such as otorhinolaryngology' should return 19</li>";
      break;

    case "largestNums":
      document.getElementById("descTitle").innerHTML = "Return Largest Numbers in Arrays";
      document.getElementById("descText").innerHTML = "Return an array consisting of the largest number from each provided sub-array. For simplicity, the provided array will contain exactly 4 sub-arrays.<br> Remember, you can iterate through an array with a simple for loop, and access each member with array syntax <var>arr[i]</var>.";
      document.getElementById("descTests").innerHTML = "<li>[[4, 5, 1, 3], [13, 27, 18, 26], [32, 35, 37, 39], [1000, 1001, 857, 1]] should return</li>[5, 27, 39, 1001]<li>[[13, 27, 18, 26], [4, 5, 1, 3], [32, 35, 37, 39], [1000, 1001, 857, 1]] should return [27, 5, 39, 1001]</li><li>[[4, 9, 1, 3], [13, 35, 18, 26], [32, 35, 97, 39], [1000000, 1001, 857, 1]] should return [9, 35, 97, 1000000]</li><li>[[17, 23, 25, 12], [25, 7, 34, 48], [4, -10, 18, 21], [-72, -3, -17, -10]] should return [25, 48, 21, -3]</li>";
      break;
