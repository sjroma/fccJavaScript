...
//console.log(largestOfFour([[4, 5, 1, 3], [13, 27, 18, 26], [32, 35, 37, 39], [1000, 1001, 857, 1]])); //should return [5, 27, 39, 1001]
...
// JSON.stringify is a way to change an array to a string that can easily be printed to the screen
console.log(JSON.stringify (largestArr));
